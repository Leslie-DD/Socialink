 ...
 * 交友activity——动态fragment
 */

public class FriendActivity2 extends NetWorkActivity implements View.OnClickListener {
    private View view;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_friend2);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.FriendSet:
                ...
                intent2.setClass(FriendActivity2.this, FriendSet.class);
                startActivity(intent2);
                break;
            case R.id.FriendFiltrate:
                // MobclickAgent.onEvent(MeetApplication.getInstance(),"event_askEnterNewAsk");
                Intent intent1 = new Intent(FriendActivity2.this, SendNew.class);
            ...
            case R.id.tvNear:
                ...
                intent3.setClass(FriendActivity2.this, FriendActivity.class);
            ...
            case R.id.tvFriend:
                ...
                intent4.putExtra("longtitude", "" + longtitude);
                intent4.putExtra("latitude", "" + latitude);
                intent4.setClass(FriendActivity2.this, FriendActivity3.class);
