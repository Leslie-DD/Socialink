...
public class News_MessageFragment extends NetWorkFragment implements XRecyclerView.LoadingListener{
    ...
    private void initDialog()
    {
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                sendPost(WenConstans.DeleteMessageBox,DelMsg, Constants.token);
                deldialog.dismiss();
            }
    ...
    private void getData(int pn, int type)
    {
        if (type == 1){
            ...
            sendPost(Constants.base_url+"/api/chat/base/myChatBox.do",GetCode, Constants.token);
        }else if (type == 2){
            setBodyParams(new String[]{"pn","ps","type"},new String[]{""+pn,""+ Constants.default_PS,""+3});
            sendPost(Constants.base_url+"/api/chat/base/myChatBox.do",LoadMore, Constants.token);
        }
