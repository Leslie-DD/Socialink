...
import com.example.heshequ.adapter.knowledge.MyColoumnAdapter;
...
public class MyColumnFragment extends NetWorkFragment implements XRecyclerView.LoadingListener, LabelsortAdapter.DoSaveListener {

    private View view;
    private XRecyclerView rv;
    private MyColoumnAdapter adapter;
    private int pn = 1;
    private int ps = 100;
    ...
    private void init() {
        ...
        adapter = new MyColoumnAdapter(mContext);
        rv.setAdapter(adapter);
        rv.setLoadingListener(this);
    }

    private void getData(int pn,int ps) {
        sendConnection(HttpRequest.HttpMethod.GET,WenConstans.getMyColumnList +"?pageSize="+ps +"&pageNum=" +pn,100,WenConstans.token);
