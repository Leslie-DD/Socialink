package com.hnu.heshequ.adapter.knowledge;
...
import com.hnu.heshequ.activity.knowledge.MyArticleDetialActivity;
...
public class MyArticleAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == 0) {
            views = LayoutInflater.from(context).inflate(R.layout.item_my_article, parent, false);
        } else {
