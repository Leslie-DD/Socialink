...
public class CollectgoodFragment extends NetWorkFragment implements XRecyclerView.LoadingListener, LabelsortAdapter.DoSaveListener {
    private View view;
    ...
    private void getData(int where) {
        ...
        sendPostConnection(WenConstans.Mycollectgood, where, WenConstans.token);
    }
