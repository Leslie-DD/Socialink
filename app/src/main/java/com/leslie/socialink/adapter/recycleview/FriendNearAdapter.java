...
import com.leslie.socialink.activity.friend.FriendNearDetail;
...
public class FriendNearAdapter extends RecyclerView.Adapter {
...
//    }
    ...
    public FriendNearAdapter(Context context) {
        super();
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(final int position) {
            ...
            tvDistance.setText("" + data.get(position).distance / 1000);
