...
import com.leslie.socialink.adapter.knowledge.MyColoumnAdapter;
...
public class MyColumnFragment extends NetWorkFragment implements XRecyclerView.LoadingListener, LabelsortAdapter.DoSaveListener {
    ...
    private void getData(int pn, int ps) {
        sendGetConnection(WenConstans.getMyColumnList + "?pageSize=" + ps + "&pageNum=" + pn, 100, WenConstans.token);
