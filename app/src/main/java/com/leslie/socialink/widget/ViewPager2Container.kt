package com.leslie.socialink.widget
...
class ViewPager2Container @JvmOverloads constructor(
    ...
    /**
     * 设置是否允许在当前 View 的 [MotionEvent.ACTION_DOWN] 事件中禁止父 View 对事件的拦截，该方法
     * 用于解决 [androidx.coordinatorlayout.widget.CoordinatorLayout] + [com.google.android.material.appbar.CollapsingToolbarLayout]
     * 在嵌套 [ViewPager2Container] 时引起的滑动冲突问题。
     *
     * 设置是否允许在 [ViewPager2Container] 的 [MotionEvent.ACTION_DOWN] 事件中禁止父View对事件的拦截，该方法
     * 用于解决 [androidx.coordinatorlayout.widget.CoordinatorLayout] + [com.google.android.material.appbar.CollapsingToolbarLayout]
     * 在嵌套 [ViewPager2Container] 时引起的滑动冲突问题。
     *
     * @param disallowParentInterceptDownEvent 是否允许 [ViewPager2Container] 在 [MotionEvent.ACTION_DOWN] 事件中禁止父View拦截事件，
     * 默认值为 false.
     *
     *   **true** 不允许 [ViewPager2Container] 在 [MotionEvent.ACTION_DOWN] 事件中禁止父View的时间拦截，
     *   设置 disallowIntercept 为 true 可以解决 [androidx.coordinatorlayout.widget.CoordinatorLayout] +
     *   [com.google.android.material.appbar.CollapsingToolbarLayout] 的滑动冲突
     *
     *   **false** 允许 [ViewPager2Container] 在 [MotionEvent.ACTION_DOWN] 时间中禁止父View的时间拦截，
     */
